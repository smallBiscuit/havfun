...
public class AddressMessage {
	...
	public String toString() {
		return "AddressMessage [addressId=" + addressId + ", clientId=" + clientId + ", firstName=" + firstName
				+ ", lastName=" + lastName + ", address1=" + address1 + ", address2=" + address2 + ", city=" + city
				+ ", postcode=" + postcode + ", countryId=" + countryId + ", countryCode=" + countryCode
				+ ", countryNameEn=" + countryNameEn + ", countryNameHk=" + countryNameHk + ", countryNameCn="
				+ countryNameCn + ", zoneId=" + zoneId + ", telephone=" + telephone + ", isBillingAddress="
				+ isBillingAddress + ", isShippingAddress=" + isShippingAddress + "]";
	}
