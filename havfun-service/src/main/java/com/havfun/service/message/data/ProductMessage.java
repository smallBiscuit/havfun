...
public class ProductMessage {
	...
	private CustomizeProductBaseMessage customizeProductBase;
	...
	public CustomizeProductBaseMessage getCustomizeProductBase() {
		return customizeProductBase;
	}

	public void setCustomizeProductBase(CustomizeProductBaseMessage customizeProductBase) {
		this.customizeProductBase = customizeProductBase;
	}

	
	@Override
	public String toString() {
		return "ProductMessage [productId=" + productId + ", productGroupId=" + productGroupId + ", nameEn=" + nameEn
				...
				+ ", lastModifiedTimestamp=" + lastModifiedTimestamp + ", customizeProductBase=" + customizeProductBase
				+ "]";
	}
