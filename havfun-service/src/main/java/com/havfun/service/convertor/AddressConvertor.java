...
public class AddressConvertor {
	...
	public final static AddressMessage convertToMessage(Address address) {
		...
		addressMessage.setCountryCode(address.getCountryCode());
		addressMessage.setCountryNameEn(address.getCountryNameEn());
		addressMessage.setCountryNameHk(address.getCountryNameHk());
		addressMessage.setCountryNameCn(address.getCountryNameCn());
