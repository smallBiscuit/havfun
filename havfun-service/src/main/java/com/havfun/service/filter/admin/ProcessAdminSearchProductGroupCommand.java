...
public class ProcessAdminSearchProductGroupCommand implements Command {
	
	/** logger */
	private static final Logger LOGGER = LogManager.getLogger(ProcessAdminSearchProductGroupCommand.class.getSimpleName());
	...
	public boolean execute(Context context) throws Exception {
		...
		AdminSearchProductGroupRequest request = (AdminSearchProductGroupRequest) context.get(AbstractHkListCoEventHandler.REQUEST);
		...
		AdminSearchProductGroupResponse response = new AdminSearchProductGroupResponse();
