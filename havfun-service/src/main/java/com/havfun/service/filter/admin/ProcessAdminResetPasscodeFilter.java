...
public class ProcessAdminResetPasscodeFilter implements Filter {
	
	/** logger */
	private static final Logger LOGGER = LogManager.getLogger(ProcessAdminResetPasscodeFilter.class.getSimpleName());
	...
	public boolean execute(Context context) throws Exception {
		...
		AdminResetPasscodeRequest request = (AdminResetPasscodeRequest) context.get(AbstractHkListCoEventHandler.REQUEST);
		...
		AdminResetPasscodeResponse response = new AdminResetPasscodeResponse();
	...
	public String getTitle() {
		return "HKlistco reset password";
	}
