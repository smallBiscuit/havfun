...
public class ReferrerLogDaoImpl implements ReferrerLogDao {
	...
	private final static String REFERRER_LOG_SELECT_SQL_BY_KEY = "select * from referrerLog where log_id = ?";

	private final static String REFERRER_LOG_DELETE_SQL_BY_KEY = "delete from referrerLog where log_id = ?";

//	private final static String REFERRER_LOG_SELECT_ALL_SQL = "select * from referrerLog";

//	private final static String REFERRER_LOG_SELECT_SQL_BY_LOG_ID = "select * from referrerLog where user_name = ?";
	...
	public Integer create(ReferrerLog newInstance) {
		...
		SimpleJdbcInsert simpleJdbcInsert = new SimpleJdbcInsert(jdbcTemplate).withTableName("referrerLog").usingGeneratedKeyColumns("log_id");
