...
public class ProductDaoImpl implements ProductDao {
	...
	private final static String PRODUCT_SELECT_ALL_SQL = "select * from product order by product_id";

	private final static String PRODUCT_SELECT_SQL_BY_PRODUCT_GROUP_ID = "select * from product where product_group_id = ?";
	
	private final static String PRODUCT_SELECT_SQL_BY_TAG = "select * from product where tag = ?";
	...
	public List<Product> readByGroupId( int groupId ) {
		return jdbcTemplate.query(
				PRODUCT_SELECT_SQL_BY_PRODUCT_GROUP_ID, 
				rowMapper, 
					new Object[]{
							groupId
						}
