...
//	private final static String CUSTOMIZE_PRODUCT_BASE_SELECT_SQL_BY_BASE_ID = "select * from customize_product_base where base_id = ?";

	private final static String CUSTOMIZE_PRODUCT_BASE_SELECT_SQL_BY_PRODUCT_ID = "select * from customize_product_base where product_id = ?";
	...
	public List<CustomizeProductBase> readByProductId(int productId) {
		return jdbcTemplate.query(
				CUSTOMIZE_PRODUCT_BASE_SELECT_SQL_BY_PRODUCT_ID, 
				rowMapper, 
					new Object[]{
							productId
						}
