...
public class OrderProductDaoImpl implements OrderProductDao {
	...
	private final static String ORDER_PRODUCT_UPDATE_SQL_BY_KEY = "update order_product set  order_id = ?, product_id = ?, name = ?, model = ?, quantity = ?, price = ?, total = ?, tax = ?, reward = ? where order_product_id = ?";
...
//	private final static String ORDER_PRODUCT_SELECT_SQL_BY_ORDER_PRODUCT_ID = "select * from order_product where order_product_id = ?";
	
	private final static String ORDER_PRODUCT_SELECT_SQL_BY_ORDER_ID = "select * from order_product where order_id = ?";
	...
	public List<OrderProduct> readByOrderId(int orderId) {
		return jdbcTemplate.query(
				ORDER_PRODUCT_SELECT_SQL_BY_ORDER_ID, 
				rowMapper, 
					new Object[]{
							orderId
						}
