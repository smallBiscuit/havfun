...
public class CouponProductDaoImpl implements CouponProductDao {
	...
	private final static String COUPON_PRODUCT_SELECT_SQL_BY_KEY = "select * from couponProduct where coupon_product_id = ?";

	private final static String COUPON_PRODUCT_DELETE_SQL_BY_KEY = "delete from couponProduct where coupon_product_id = ?";

//	private final static String COUPON_PRODUCT_SELECT_ALL_SQL = "select * from couponProduct";

//	private final static String COUPON_PRODUCT_SELECT_SQL_BY_COUPON_PRODUCT_ID = "select * from couponProduct where user_name = ?";
	...
	public Integer create(CouponProduct newInstance) {
		...
		SimpleJdbcInsert simpleJdbcInsert = new SimpleJdbcInsert(jdbcTemplate).withTableName("couponProduct").usingGeneratedKeyColumns("coupon_product_id");
