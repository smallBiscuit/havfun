...
public class ClientLoginHistoryDaoImpl implements ClientLoginHistoryDao {
	...
	private final static String CLIENT_LOGIN_HISTORY_SELECT_SQL_BY_KEY = "select * from clientLoginHistory where client_login_history_id = ?";

	private final static String CLIENT_LOGIN_HISTORY_DELETE_SQL_BY_KEY = "delete from clientLoginHistory where client_login_history_id = ?";

//	private final static String CLIENT_LOGIN_HISTORY_SELECT_ALL_SQL = "select * from clientLoginHistory";

//	private final static String CLIENT_LOGIN_HISTORY_SELECT_SQL_BY_CLIENT_LOGIN_HISTORY_ID = "select * from clientLoginHistory where user_name = ?";
	...
	public Integer create(ClientLoginHistory newInstance) {
		...
		SimpleJdbcInsert simpleJdbcInsert = new SimpleJdbcInsert(jdbcTemplate).withTableName("clientLoginHistory").usingGeneratedKeyColumns("client_login_history_id");
