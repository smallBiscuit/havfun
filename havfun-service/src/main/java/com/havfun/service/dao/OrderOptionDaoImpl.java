...
public class OrderOptionDaoImpl implements OrderOptionDao {
	...
	private final static String ORDER_OPTION_SELECT_SQL_BY_KEY = "select * from orderOption where order_option_id = ?";

	private final static String ORDER_OPTION_DELETE_SQL_BY_KEY = "delete from orderOption where order_option_id = ?";

//	private final static String ORDER_OPTION_SELECT_ALL_SQL = "select * from orderOption";

//	private final static String ORDER_OPTION_SELECT_SQL_BY_ORDER_OPTION_ID = "select * from orderOption where user_name = ?";
	...
	public Integer create(OrderOption newInstance) {
		...
		SimpleJdbcInsert simpleJdbcInsert = new SimpleJdbcInsert(jdbcTemplate).withTableName("orderOption").usingGeneratedKeyColumns("order_option_id");
