...
public class UserGetPasscodeDaoImpl implements UserGetPasscodeDao {
	...
	private final static String USER_GET_PASSCODE_SELECT_SQL_BY_KEY = "select * from userGetPasscode where user_id = ?";

	private final static String USER_GET_PASSCODE_DELETE_SQL_BY_KEY = "delete from userGetPasscode where user_id = ?";

//	private final static String USER_GET_PASSCODE_SELECT_ALL_SQL = "select * from userGetPasscode";

//	private final static String USER_GET_PASSCODE_SELECT_SQL_BY_USER_ID = "select * from userGetPasscode where user_name = ?";
	...
	public Integer create(UserGetPasscode newInstance) {
		...
		SimpleJdbcInsert simpleJdbcInsert = new SimpleJdbcInsert(jdbcTemplate).withTableName("userGetPasscode").usingGeneratedKeyColumns("user_id");
