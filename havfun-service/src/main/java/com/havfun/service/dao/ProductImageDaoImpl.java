...
public class ProductImageDaoImpl implements ProductImageDao {
	...
	private final static String PRODUCT_IMAGE_SELECT_SQL_BY_KEY = "select * from productImage where product_image_id = ?";

	private final static String PRODUCT_IMAGE_DELETE_SQL_BY_KEY = "delete from productImage where product_image_id = ?";

//	private final static String PRODUCT_IMAGE_SELECT_ALL_SQL = "select * from productImage";

//	private final static String PRODUCT_IMAGE_SELECT_SQL_BY_PRODUCT_IMAGE_ID = "select * from productImage where user_name = ?";
	...
	public Integer create(ProductImage newInstance) {
		...
		SimpleJdbcInsert simpleJdbcInsert = new SimpleJdbcInsert(jdbcTemplate).withTableName("productImage").usingGeneratedKeyColumns("product_image_id");
