...
public class OrderOptionValueDaoImpl implements OrderOptionValueDao {
	...
	private final static String ORDER_OPTION_VALUE_SELECT_SQL_BY_KEY = "select * from order_option_value where order_option_value_id = ?";

	private final static String ORDER_OPTION_VALUE_DELETE_SQL_BY_KEY = "delete from order_option_value where order_option_value_id = ?";

	private final static String ORDER_OPTION_VALUE_SELECT_ALL_SQL = "select * from order_option_value";

	private final static String ORDER_OPTION_VALUE_SELECT_SQL_BY_ORDER_OPTION_VALUE_ID = "select * from order_option_value where user_name = ?";
	...
	public Integer create(OrderOptionValue newInstance) {
		...
		SimpleJdbcInsert simpleJdbcInsert = new SimpleJdbcInsert(jdbcTemplate).withTableName("order_option_value").usingGeneratedKeyColumns("order_option_value_id");
