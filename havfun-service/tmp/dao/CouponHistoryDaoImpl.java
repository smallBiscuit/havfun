...
public class CouponHistoryDaoImpl implements CouponHistoryDao {
	...
	private final static String COUPON_HISTORY_SELECT_SQL_BY_KEY = "select * from coupon_history where coupon_history_id = ?";

	private final static String COUPON_HISTORY_DELETE_SQL_BY_KEY = "delete from coupon_history where coupon_history_id = ?";

	private final static String COUPON_HISTORY_SELECT_ALL_SQL = "select * from coupon_history";

	private final static String COUPON_HISTORY_SELECT_SQL_BY_COUPON_HISTORY_ID = "select * from coupon_history where user_name = ?";
	...
	public Integer create(CouponHistory newInstance) {
		...
		SimpleJdbcInsert simpleJdbcInsert = new SimpleJdbcInsert(jdbcTemplate).withTableName("coupon_history").usingGeneratedKeyColumns("coupon_history_id");
