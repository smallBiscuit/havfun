...
public class ZoneToGeoZoneDaoImpl implements ZoneToGeoZoneDao {
	...
	private final static String ZONE_TO_GEO_ZONE_SELECT_SQL_BY_KEY = "select * from zone_to_geo_zone where zone_to_geo_zone = ?";

	private final static String ZONE_TO_GEO_ZONE_DELETE_SQL_BY_KEY = "delete from zone_to_geo_zone where zone_to_geo_zone = ?";

	private final static String ZONE_TO_GEO_ZONE_SELECT_ALL_SQL = "select * from zone_to_geo_zone";

	private final static String ZONE_TO_GEO_ZONE_SELECT_SQL_BY_ZONE_TO_GEO_ZONE = "select * from zone_to_geo_zone where user_name = ?";
	...
	public Integer create(ZoneToGeoZone newInstance) {
		...
		SimpleJdbcInsert simpleJdbcInsert = new SimpleJdbcInsert(jdbcTemplate).withTableName("zone_to_geo_zone").usingGeneratedKeyColumns("zone_to_geo_zone");
