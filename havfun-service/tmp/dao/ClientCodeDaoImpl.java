...
public class ClientCodeDaoImpl implements ClientCodeDao {
	...
	private final static String CLIENT_CODE_SELECT_SQL_BY_KEY = "select * from client_code where client_code_id = ?";

	private final static String CLIENT_CODE_DELETE_SQL_BY_KEY = "delete from client_code where client_code_id = ?";

	private final static String CLIENT_CODE_SELECT_ALL_SQL = "select * from client_code";

	private final static String CLIENT_CODE_SELECT_SQL_BY_CLIENT_CODE_ID = "select * from client_code where user_name = ?";
	...
	public Integer create(ClientCode newInstance) {
		...
		SimpleJdbcInsert simpleJdbcInsert = new SimpleJdbcInsert(jdbcTemplate).withTableName("client_code").usingGeneratedKeyColumns("client_code_id");
