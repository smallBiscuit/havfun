...
public class ProductDiscountDaoImpl implements ProductDiscountDao {
	...
	private final static String PRODUCT_DISCOUNT_SELECT_SQL_BY_KEY = "select * from product_discount where product_discount_id = ?";

	private final static String PRODUCT_DISCOUNT_DELETE_SQL_BY_KEY = "delete from product_discount where product_discount_id = ?";

	private final static String PRODUCT_DISCOUNT_SELECT_ALL_SQL = "select * from product_discount";

	private final static String PRODUCT_DISCOUNT_SELECT_SQL_BY_PRODUCT_DISCOUNT_ID = "select * from product_discount where user_name = ?";
	...
	public Integer create(ProductDiscount newInstance) {
		...
		SimpleJdbcInsert simpleJdbcInsert = new SimpleJdbcInsert(jdbcTemplate).withTableName("product_discount").usingGeneratedKeyColumns("product_discount_id");
