...
public class OrderRowMapper implements RowMapper<Order> {
	...
	public Order mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		order.setInvoiceNo(rs.getInt("invoice_no"));
		...
		order.setBillingAddress1(rs.getString("billing_address1"));
		order.setBillingAddress2(rs.getString("billing_address2"));
		...
		order.setShippingAddress1(rs.getString("shipping_address1"));
		order.setShippingAddress2(rs.getString("shipping_address2"));
		...
		order.setCreateTimestamp(rs.getLong("create_timestamp"));
		order.setLastModifiedTimestamp(rs.getLong("last_modified_timestamp"));
		return order;
	}
