		...
		<div id="keystock">
			<form enctype="multipart/form-data">
				<table width="906px" border="0" cellpadding="1" cellspacing="0">
					...
					<tr><ari:webComponent bundle="${label}" pageMode="${pageMode}" webComponent="${product_group_id}" value="${dataImage.productGroupId}" origValue="${origDataImage.productGroupId}"></ari:webComponent></tr>
					<tr><ari:webComponent bundle="${label}" pageMode="${pageMode}" webComponent="${product_group_name_en}" value="${dataImage.nameEn}" origValue="${origDataImage.nameEn}"></ari:webComponent></tr>
					<tr><ari:webComponent bundle="${label}" pageMode="${pageMode}" webComponent="${product_group_image}" value="${imagePreview}" origValue="${origDataImage.image}"></ari:webComponent></tr>
					<tr><ari:webComponent bundle="${label}" pageMode="${pageMode}" webComponent="${product_group_parent_id}" value="${dataImage.parentId}" origValue="${origDataImage.parentId}"></ari:webComponent></tr>
					<tr><ari:webComponent bundle="${label}" pageMode="${pageMode}" webComponent="${product_group_status}" choiceList="${productGroupStatusList}" value="${dataImage.status.value}" origValue="${origDataImage.status.value}"></ari:webComponent></tr>
					<tr><ari:webComponent bundle="${label}" pageMode="${pageMode}" webComponent="${product_group_create_timestamp}" value="${dataImage.createTimestamp}" origValue="${origDataImage.createTimestamp}"></ari:webComponent></tr>
					<tr><ari:webComponent bundle="${label}" pageMode="${pageMode}" webComponent="${product_group_last_modified_timestamp}" value="${dataImage.lastModifiedTimestamp}" origValue="${origDataImage.lastModifiedTimestamp}"></ari:webComponent></tr>
...
$('#product_group_image').on('change', function(){
	
	readImageURL( '#product_group_image' );
